...
/*=============================================================================
  ...
  - The X4 and X5 Timer0 code only differs by TIMSK0 / TIMSK and TIFR0 / 
    TIFR.  If a third processor follows the same pattern, make the Timer0 
    code available as a "generic Timer0".
